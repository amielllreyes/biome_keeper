...
export default function Home() {
  return (
    <>
      ...
      {/* VIDEO SECTION (appears when scrolling) */}
      <section className="bg-black text-white py-24 px-6 flex flex-col items-center justify-center">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <source src="/PromVid.mp4" type="video/mp4" />
